...
2. Push & Scan: The Docker image was pushed to AWS Elastic Container Registry (ECR).

3. Secure: The ECR registry was configured with "Enhanced scanning" and a filter to "Scan on push" for the wiz-secure-app repository, automatically discovering known software vulnerabilities (CVEs).
...
## ☁️DEMO 2: The "Result" - The Vulnerability Report
